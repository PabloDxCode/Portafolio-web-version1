...
<head>
	...
	<title>Vacante Desarrollo</title>
	...
	<div class="contenido">
		...
		<nav>
			<ul class="menu">
				...
				<li><a href="vBaseDatos.php">Vacante Base de datos</a></li>
				<li class="activo"><a href="vDesarrollo.php">Vacante Desarrollo</a></li>
				<li><a href="../index.php">Biografia</a></li>
			</ul>
		</nav>

		<div class="datos">
			<div class="titulo"><h1>Vacante de Desarrollo</h1></div>
				
				<?php
					foreach ($xml->desarrollo as $vacante) {
				?>
